Le repository 6ActivityP2 est le support de l'activité de la partie 2 du cours " Gérer votre code avec Git et GitHub"

VOICI DONC LES CONSIGNES ET LES ETAPES A SUIVRE POUR REALISER CETTE ACTIVITE :
...
1-	Vous devez créer un repository Git simple contenant :
...
2-	Une fois que vous avez créé votre repository Git, envoyez-le sur GitHub, puis copiez l’URL du repository GitHub créé spécialement pour cette activité (format: https://github.com/votrenomd'utilisateur/votreprojet). 
...
3-	Enfin, téléchargez ce document texte. 
